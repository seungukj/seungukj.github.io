...
온도 $T$에 놓인 1개의 이진 비트의 정보가 삭제될 경우, 외부로 엔트로피를 방출하는 과정은 열 방출로 나타나며, 그 열량은 $Q_{\text{열원}}\geq T\Delta S = k_BT\ln 2$로 나타난다. 임의로 이 열을 **Landauer 열**이라고 부르자. (즉, 이 용어가 표준용어인지는 잘 모른다.)(Vopson의 정보질량 이론은 이를 되려 정보 자체가 가지고 있는 내재된 에너지/질량으로 보는 것으로 이해하고 있다.)
